...
const NewProductCommentForm = ({link, id}) => {
    ...
    const onSubmit = data => { 
        ...
        new Service().patchData(`catalog/${id}`, data);
        reset();
    }
    ...
    return(
        <div className={s.form__containet}>
            ...
            <form autoComplete='off' onSubmit={handleSubmit(onSubmit)}>   
                ...
                <div className={s.input__container}>
                    <button onClick={() => setShowMessage(true)} className={s.button}><FontAwesomeIcon icon={faPencil} />Додати коментар</button>
                </div>
            </form>
